                ...
                <div class="modal-content">
                    ...
                    <form action="" method="post" name="addingMenuForm" id="addingMenuForm">
                        <div class="modal-body">                  
                            ...
                            <input type="text" name="slug" id="menu_slug" class="form-control" placeholder="Slug">
            ...
            <ul class="nav nav-tabs" role="tablist">
                @if ($categories->isNotEmpty())
                    @foreach ($categories as $value)
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs_{{ $value->id }}" role="tab">{{ $value->name }} <span class="count-sub">{{ $totalMenu }}</span></a>
                        </li>
                    @endforeach
                @endif
            </ul>
